...
pheno2 = filter(pheno2, pheno2$focal!="XNA"|pheno2$focal!="XNA")
pheno2 = pheno2[-which(is.na(pheno2$rosette)),]

# MAF cutoff 5%
geno$g = geno$g[,levels(factor(pheno2$focal))]
...
saveRDS(out,file="../output/NeiGWAS_Wuest_et_al_sim_all_rosetteZ.rds")
